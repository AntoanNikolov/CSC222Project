...
<span style="font-size: 1.2em;">This project for our CS222 class is a 2D turret shooter game with some custom features and voice control. The details of the project are listed below.</span>
